...
# Source this file, then add theme_style_figures() and a Set1 scale to a plot.
...
theme_style_figures <- function(font_size = 24, line_width = 3) {
  ...
  s <- figure_style(font_size, line_width)
  ggplot2::theme(
...
scale_colour_style_figures <- function(...) {
  ggplot2::scale_colour_manual(values = unname(.style_figures_set1), ...)
}

scale_fill_style_figures <- function(...) {
  ggplot2::scale_fill_manual(values = unname(.style_figures_set1), ...)
}
